    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.grid}>
          ...
          <input style={styles.input} name="ticker" value={form.ticker} onChange={handleChange} placeholder="AAPL" />
          ...
          <input style={styles.input} name="account" value={form.account} onChange={handleChange} placeholder="IRA" />
        </div>
